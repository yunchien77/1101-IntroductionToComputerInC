...
#include<time.h>
#define n 10
//這是一個將二維轉成一維陣列，再用氣泡排序法進階版由大到小做排序，之後再轉成二維陣列輸出的麻煩過程
int bubble_sort_advanced(int a[], int num);
int main(){
   ...
   //bubble sort(advanced) of 1D array
   bubble_sort_advanced(arr2, size*size);
